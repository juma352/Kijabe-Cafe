...
<head>
    ...
    <title>Register • Kijabe POS</title>
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .role-label{display:block;margin-bottom:6px;color:#ddd;font-size:13px}
        .back-link{color:#fff;opacity:0.85;text-decoration:none}
